...
wget https://github.com/aler9/rtsp-simple-server/releases/download/v0.20.0/rtsp-simple-server_v0.20.0_linux_armv7.tar.gz
tar xvfz rtsp-simple-server_v0.20.0_linux_armv7.tar.gz
