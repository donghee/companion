...
do
  ...
  # gstreamer rpicam
  #gst-launch-1.0 rpicamsrc keyframe-interval=2 bitrate=2500000 annotation-mode=date+time preview=false ! video/x-h264,width=1280,height=720,framerate=15/1,profile=high ! h264parse ! rtspclientsink location=$STREAM_URL/$STREAM_KEY
